...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://www.dropbox.com/s/b5bfltq3texar04/badvpn-udpgw?dl=0 /dev/null
			wget https://raw.githubusercontent.com/JeanRocha91x/SSHPLUS/main/badvpn/antcrashvpn.sh -o /dev/null
